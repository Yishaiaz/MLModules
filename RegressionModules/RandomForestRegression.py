...
class RandomForestRegression:
    ...
    def __init__(self, number_of_trees=10):
        self.RFR_regressor = RandomForestRegressor(n_estimators=number_of_trees, random_state=0)
    ...
    def train_module(self,
                     x_dataset,
                     y_dataset):
        self.RFR_regressor.fit(X=x_dataset, y=y_dataset)
    ...
    def run_module(self, x_dataset):
        ...
        return self.RFR_regressor.predict(X=x_dataset)
    ...
    def visualize_module(self,
        ...
        plt.plot(X_grid, self.RFR_regressor.predict(X_grid), color=line_color)
        plt.title(title)
        plt.xlabel(xlabel)
        plt.ylabel(ylabel)
        plt.show()
