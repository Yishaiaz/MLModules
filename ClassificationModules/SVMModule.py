...
class SVMModule:
    ...
    def __init__(self,
        ...
        'precomputed' .\n
        default is 'rbf' \n
        :param degree: \nan int. default is 2, only significant when kernel_type is 'poly'.
        """
    ...
    def train_module(self,
                     x_dataset,
                     y_dataset):
        self.classifier.fit(X=x_dataset, y=y_dataset)
    ...
    def test_module(self,
        ...
        y_pred = self.classifier.predict(X=x_test)
    ...
    def run_module(self, x_dataset):
        ...
        return self.classifier.predict(X=x_dataset)
    ...
    def visualize_module(self,
        ...
        plt.contourf(x1,
                     x2,
                     self.classifier.predict(np.array([x1.ravel(),
